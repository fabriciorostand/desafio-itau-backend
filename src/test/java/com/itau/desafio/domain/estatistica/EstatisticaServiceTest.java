...
class EstatisticaServiceTest {
    ...
    void calcularEstatisticasTransacoesCenario2() {
        transacaoService.registrar(new RegistrarTransacaoRequest(500.0, OffsetDateTime.now(clock).minusSeconds(10)));

        EstatisticaResponse response = estatisticaService.calcularEstatisticasTransacoes(60L);

        assertThat(response.count()).isEqualTo(1);
        assertThat(response.sum()).isEqualTo(500);
        assertThat(response.avg()).isEqualTo(500);
        assertThat(response.min()).isEqualTo(500);
        assertThat(response.max()).isEqualTo(500);
    }
    ...
    void calcularEstatisticasTransacoesCenario3() {
        transacaoService.registrar(new RegistrarTransacaoRequest(200.0, OffsetDateTime.now(clock).minusSeconds(10)));
        transacaoService.registrar(new RegistrarTransacaoRequest(100.0, OffsetDateTime.now(clock).minusSeconds(20)));
    ...
    void calcularEstatisticasTransacoesCenario4() {
        transacaoService.registrar(new RegistrarTransacaoRequest(0.0, OffsetDateTime.now(clock).minusSeconds(30)));
        transacaoService.registrar(new RegistrarTransacaoRequest(100.0, OffsetDateTime.now(clock).minusSeconds(40)));
    ...
    void calcularEstatisticasTransacoesCenario5() {
        transacaoService.registrar(new RegistrarTransacaoRequest(200.0, OffsetDateTime.now(clock).minusSeconds(60)));
        transacaoService.registrar(new RegistrarTransacaoRequest(100.0, OffsetDateTime.now(clock).minusSeconds(60)));
    ...
    void calcularEstatisticasTransacoesCenario6() {
        transacaoService.registrar(new RegistrarTransacaoRequest(200.0, OffsetDateTime.now(clock).minusSeconds(40)));
        transacaoService.registrar(new RegistrarTransacaoRequest(100.0, OffsetDateTime.now(clock).minusSeconds(50)));
        transacaoService.registrar(new RegistrarTransacaoRequest(50.0, OffsetDateTime.now(clock).minusSeconds(80)));
    ...
    void calcularEstatisticasTransacoesCenario7() {
        transacaoService.registrar(new RegistrarTransacaoRequest(200.0, OffsetDateTime.now(clock).minusSeconds(90)));
        transacaoService.registrar(new RegistrarTransacaoRequest(100.0, OffsetDateTime.now(clock).minusSeconds(100)));
